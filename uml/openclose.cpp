...
//     }
//     void sqldatabase(){
//         cout<<" data  succcessfully save in the sql database"<<endl;    
//     }
//     void mongodb(){
//         cout<<"data successfully save in the mongodb"<<endl;
//     }  
//     void filestorage(){
//         cout<<"data successfully save in the file storage"<<endl;
//     }
...
class sqldatabase:public shoppingstoradge{
   void save(shoppingcart*cart)override{
    cout<<"successfully your data save in the sql database"<<endl;
   }
}
class mongodb:public shoppingcart{
    void save(shoppingcart*cart)overide{
        cout<<"the data save successfully in the mongodb"<<endl;
    }
}
class filesasved:public shoppingcart{
void save(shoppingcart*cart)override{
    cout<<"the data save successfully in the file"<<endl;
}
}
int main()
